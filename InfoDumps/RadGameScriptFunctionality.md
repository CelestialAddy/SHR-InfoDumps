...
- Sound resource/Convinit/Noboxconv names are **case-sensitive**, relative to the SPT. If in the SPT your conversation is named `c_Churn`, calls in functions should reflect that. Every line should follow the same naming style, if there are multiple.
